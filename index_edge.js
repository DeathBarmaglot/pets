    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid163", tween: [ "style", "${_a2}", "left", '-214px', { fromValue: '-214px'}], position: 4750, duration: 0 },
                ...
                { id: "eid146", tween: [ "style", "${_gr}", "opacity", '0', { fromValue: '1'}], position: 18616, duration: 444, easing: "easeInOutCubic" },
                ...
                { id: "eid160", tween: [ "style", "${_t}", "opacity", '0', { fromValue: '1'}], position: 15654, duration: 214, easing: "easeInOutCubic" },
                { id: "eid161", tween: [ "style", "${_t}", "opacity", '1', { fromValue: '0'}], position: 15868, duration: 373, easing: "easeInOutCubic" },
                ...
                { id: "eid134", tween: [ "style", "${_li}", "background-position", [0,-211.76470447059], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,-178.823528]}], position: 15349, duration: 305, easing: "easeInOutCubic" },
                { id: "eid135", tween: [ "style", "${_li}", "background-position", [0,-237.64705694118], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,-211.764704]}], position: 17115, duration: 338, easing: "easeInOutCubic" },
                ...
                { id: "eid86", tween: [ "style", "${_a2}", "opacity", '1', { fromValue: '0'}], position: 15349, duration: 104, easing: "easeInOutCubic" },
                { id: "eid91", tween: [ "style", "${_a2}", "opacity", '0', { fromValue: '1'}], position: 17000, duration: 115, easing: "easeInOutCubic" },
                { id: "eid92", tween: [ "style", "${_a2}", "opacity", '1', { fromValue: '0'}], position: 17453, duration: 115, easing: "easeInOutCubic" },
                { id: "eid71", tween: [ "style", "${_a3}", "opacity", '1', { fromValue: '0'}], position: 13500, duration: 115, easing: "easeInOutCubic" },
                { id: "eid84", tween: [ "style", "${_a3}", "opacity", '0', { fromValue: '1'}], position: 15099, duration: 104, easing: "easeInOutCubic" },
                { id: "eid37", tween: [ "style", "${_a1}", "clip", [2,224.13308715820313,123,103.08131408691406], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [2,251.44102478027344,123,103.08131408691406]}], position: 3083, duration: 534, easing: "easeInOutCubic" },
                { id: "eid40", tween: [ "style", "${_a1}", "clip", [2,216.44102478027344,123,123.08131408691406], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [2,224.13308715820313,123,103.08131408691406]}], position: 5333, duration: 568, easing: "easeInOutCubic" },
                ...
                { id: "eid93", tween: [ "style", "${_a2}", "background-position", [240.71826171875,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,0]}], position: 17000, duration: 568, easing: "easeInOutCubic" },
                { id: "eid142", tween: [ "style", "${_a2}", "top", '218px', { fromValue: '218px'}], position: 19116, duration: 0 },
                ...
                { id: "eid85", tween: [ "transform", "${_ci}", "rotateZ", '-180deg', { fromValue: '-90deg'}], position: 15203, duration: 146, easing: "easeInOutCubic" },
